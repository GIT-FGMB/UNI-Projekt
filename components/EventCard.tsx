...
export default function EventCard({ event }: { event: SportEvent }) {
  ...
  return (
    <div className="animate-fade-in mb-4 bg-olive-700 rounded-lg">
      ...
      <div className="w-full aspect-[4/3] bg-olive-600 border-y border-olive-500 relative flex flex-col items-center justify-center">
        ...
        <h3 className="text-white text-lg font-bold text-center px-6">{event.title}</h3>
        <div className="flex items-center gap-4 mt-3 text-olive-300 text-xs">
      ...
      <div className="flex items-center gap-4 px-4 py-3">
        <button onClick={handleLike} className="flex items-center gap-1.5 transition-all duration-200 active:scale-125">
          <Heart
            size={24}
            className={event.liked ? "fill-red-500 text-red-500" : "text-olive-300"}
        ...
        <button className="flex items-center gap-1.5">
          <Share2 size={24} className="text-olive-300" strokeWidth={1.5} />
        </button>
      </div>
      ...
      {/* Location */}
      <div className="flex items-center gap-1 px-4 pb-2 text-olive-300 text-xs">
        <MapPin size={12} />
              ...
              {currentUser ? (
                <div className="flex items-center gap-2 pt-2 border-t border-olive-600">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-white text-sm placeholder-olive-400 outline-none"
                  />
                  <button
                ...
                <button onClick={() => setActiveTab("login")} className="text-terra-300 text-xs font-medium pt-2">

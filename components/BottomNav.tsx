...
export default function BottomNav() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 bg-gray-950/95 backdrop-blur-lg border-t border-gray-800 pb-6 pt-2 z-30">
      <div className="flex justify-around items-center">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              {tab.id === "create" ? (
                <div className={`p-1.5 rounded-xl ${isActive ? "bg-green-500/20" : ""}`}>
                ...
                <div className="relative">
                  ...
                  {tab.id === "inbox" && totalUnread > 0 && (
                    <span className="absolute -top-1.5 -right-2 w-4 h-4 bg-green-500 text-white text-[8px] font-bold rounded-full flex items-center justify-center">
                      {totalUnread}
                    </span>
                  )}
                </div>
